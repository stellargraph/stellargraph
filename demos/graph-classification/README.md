...
| [Supervised graph classification with GCN](https://stellargraph.readthedocs.io/en/stable/demos/graph-classification/supervised-graph-classification.html) | [source](supervised-graph-classification.ipynb) |
