...
latex_documents = [
    (master_doc, 'StellarGraph.tex', 'StellarGraph Documentation',
     'Data61, CSIRO', 'manual'),
]
...
man_pages = [
    (master_doc, 'stellargraph', 'StellarGraph Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'StellarGraph', 'StellarGraph Documentation',
     author, 'StellarGraph', 'One line description of project.',
     'Miscellaneous'),
]
