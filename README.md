...
| TGCN [19] | The `GraphConvolutionLSTM` model follows the Temporal Graph Convolutional Network for Traffic Prediction proposed in the TGCN paper with a few enhancements. |
