...
class UnsupervisedSampler:
    """
        ...
        Negative samples are contexts generated for each target based on a sampling distribtution. 
        ...
        Args:
            ...
            nodes: <iterable of nodes from the graph> root nodes from which individual walks start.
            length: <int> An integer value for the length of the walk. Length at least 2.
    ...
    def generator(self, batch_size):
        ...
        """
        This method yields a batch_size of positive and negative samples from the graph on demand. 
        A positive even integer for batch_size must be provided.
        This method generates one walk at a time of a given length from each root node. 
        It extracts positive pairs from the walks and sample a negative pair for each positive
        one from a given sampling distribution. 
        It returns the batch_size of postive and negative samples.
