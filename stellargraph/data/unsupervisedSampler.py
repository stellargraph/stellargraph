...
class UnsupervisedSampler:
    """
        This class does unsupervised sampling in a graph. 
        It requires at least a Stellargraph instance and a walker. The walker is the the graph sampling strategy, such as uniform random walk, biased random walk etc.
