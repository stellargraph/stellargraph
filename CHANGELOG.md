...
- The `method="chebyshev"` option to `FullBatchNodeGenerator`, `FullBatchLinkGenerator` and `GCN_Aadj_feats_op` has been removed, because it did not work [\#1028](https://github.com/stellargraph/stellargraph/pull/1028)
